# to split csvs
# all credit cgoes to traviswaelbro. https://gist.github.com/traviswaelbro/fefc37b1ad36196e6b92cbb8cba8baa6
...
def split_csv(source_filepath, dest_path, result_filename_prefix, row_limit):
    ...
    with open(source_filepath, 'r') as source:
        ...
        while records_exist:
            ...
            i = 0
            target_filename = f'{file_number}_{result_filename_prefix}.csv'
...
split_csv('C:/Users/dbocq/Downloads/conwy_uprn_12char.csv', 'C:/Users/dbocq/Scrapping/uprn_rerun/', 'conwy_uprn_12char', 200)
#split_csv('C:/Users/dbocq/Downloads/NSUL_AUG_2022_WA.csv